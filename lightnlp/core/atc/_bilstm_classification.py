...
from ...nn.models.atc import BiLSTMClassificationModel
from ...trainer import ATCTrainer


class BiLSTMClassification(BaseModelMixin):
    def __init__(self,
                 device=None,
                 lr=1e-4,
                 eps=1e-8,
        ...
        super(BiLSTMClassification, self).__init__(device=device)
        self.lr = lr
        self.eps = eps
    ...
    def train(self, data_path=None, corpus=None, label=None):
        ...
        model = BiLSTMClassificationModel(label_num=data_loader.label_num,
    ...
    def predict(self, data=None, data_path=None, verbose=1, n_jobs=1, **kwargs):
        self.model.batch_size = 1
        return super().predict(data=data, data_path=data_path, batch_size=1, verbose=verbose, n_jobs=n_jobs)
        ...
        #
        # test_data = self.data_loader.load_predict(corpus, batch_size=1, n_jobs=n_jobs)
        #
